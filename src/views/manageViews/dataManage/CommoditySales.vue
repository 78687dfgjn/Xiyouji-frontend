  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="销售量" prop="quantitySold">
          <el-input v-model="infoForm.quantitySold" clearable></el-input>
        </el-form-item>
    ...
    >
      ...
      <el-table-column prop="commodityTitle" sortable label="商品标题" width="280">
      </el-table-column>
      <!--      <el-table-column prop="commodityId" sortable label="商品编号">-->
      <!--      </el-table-column>-->
      <!--      -->
      <el-table-column
          prop="saleDate"
      ...
      <el-table-column prop="quantitySold" sortable label="销售量">
      </el-table-column>
      <el-table-column label="操作" fixed="right" class="dif">
        <template slot-scope="scope">
          <el-button-group class="operation">
            ...
            <el-button type="danger" @click="singleDel(scope.row.saleId)">
...
export default {
  ...
  methods: {
    ...
    //删除一个用户
    delete(id) {
      this.request.delete("/commoditySales/" + id).then((res) => {
        if (res) {
    ...
    submitForm(infoForm) {
      this.$refs[infoForm].validate((valid) => {
        if (valid) {
          this.request.post("/commoditySales", this.infoForm).then((res) => {
            if (res) {
              // console.log(res);
